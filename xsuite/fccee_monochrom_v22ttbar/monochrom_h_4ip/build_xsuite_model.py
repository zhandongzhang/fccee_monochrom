...
opt1 = line.match(
    ...
    vary=xt.VaryList(['k1qa1.m','k1qa2.m','k1qa3.m','k1qa4.m','k1qa5.m','k1qa6.m','k1qb1','k1qb2','k1qb3','k1qb4','k1qb5','k1qb6',], step=1e-8,
    ),
    targets=[
        xt.TargetSet(at='ip.2', betx=1, bety=0.0016, alfx=0, alfy=0, tol=1e-5),
    ]
)
opt1.solve()
...
opt2 = line.match(
    ...
    method='4d',
    start='ip.3', end='ip.4',
    init=tw_thick_no_rad.get_twiss_init('ip.3'),
    vary=xt.VaryList(['k1qa1','k1qa2','k1qa3','k1qa4','k1qa5','k1qa6','k1qb1.m','k1qb2.m','k1qb3.m','k1qb4.m','k1qb5.m','k1qb6.m',], step=1e-8,
    ),
    targets=[
        xt.TargetSet(at='ip.4', betx=0.09, bety=0.001, alfx=0, alfy=0, tol=1e-5),
    ]
)
opt2.solve()
...
opt4 = line.match(
    ...
    start='ip.1', end='ip.8',
    init=tw_thick_no_rad.get_twiss_init('ip.1'),
    vary=xt.VaryList(['k1qrfr1', 'k1qrfr2', 'k1qrfr3', 'k1qrfr4','k1qrfr5','k1qrdr1','k1qrdr2','k1qrdr3','k1qrdr4','k1qrdr5','k1qi2','k1qi3','k1qi4','k1qi5','k1qi6','k1qi7','k1qi8','k1qi9','k1qia','k1qu8','k1qu7','k1qu4','k1qu3','k1qu2','k1qu1',], step=1e-8,
    ),
    targets=[
...
print('\n Beta at the IPs:')
tw_thin_no_rad.rows['ip.*'].cols['betx bety dx dpx'].show()
